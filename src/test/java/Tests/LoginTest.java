...
public class LoginTest extends BasePage {
   ...
   @AfterClass
    ...
    public static void verification_of_title_logo_and_login_with_blank_details() throws Exception {
        ...
        assertEquals(expectedTitle, actualTitle,"Title is not Match");
...
//        loginPageObjects.VerifyAssertError();
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Story("story_id: 011  - platfomrAdminAccess")
    @Description("verification_platfomrAdminAccess")
    @Test (priority=11,groups="smoke", description = "platfomrAdminAccess")
